...
public class CustomerManager implements Runnable {
    ...
    //public static ArrayList<CustomerManager> clients = new ArrayList<>();

    public CustomerManager(Socket socket) {
        try {
            this.socket = socket;
            bufferedWriter = new BufferedWriter(new OutputStreamWriter(socket.getOutputStream()));
            bufferedReader = new BufferedReader(new InputStreamReader(socket.getInputStream()));
            name = bufferedReader.readLine();
            CustomerManagerSingleton.getInstance().add(this);
    ...
    private void removeClient() {
        CustomerManagerSingleton.getInstance().remove(this);
    ...
    private void broadcastMessage(String massage) {
        for (CustomerManager client : CustomerManagerSingleton.getInstance()) {
            try {
